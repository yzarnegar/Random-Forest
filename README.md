...
The aim of this study is investigating and comparing the relations between biomechanical attributes as predictors with developing vertebral column diseases like Disc hernia or Spondylolisthesis, using ML teqniques Random Forest and Boosting (AdaBoostM1). Then the performance and model fit of these methods will be compared to assess which one could be more successful explaining the data with less error.
